...
module qsys1_mm_interconnect_0 (
	...
	wire  [102:0] i2c_0_csr_agent_rf_source_data;                                     // i2c_0_csr_agent:rf_source_data -> i2c_0_csr_agent_rsp_fifo:in_data
	...
	wire  [102:0] i2c_0_csr_agent_rsp_fifo_out_data;                                  // i2c_0_csr_agent_rsp_fifo:out_data -> i2c_0_csr_agent:rf_sink_data
	...
	wire          cmd_mux_src_valid;                                                  // cmd_mux:src_valid -> i2c_0_csr_agent:cp_valid
	wire  [101:0] cmd_mux_src_data;                                                   // cmd_mux:src_data -> i2c_0_csr_agent:cp_data
	wire          cmd_mux_src_ready;                                                  // i2c_0_csr_agent:cp_ready -> cmd_mux:src_ready
	wire    [1:0] cmd_mux_src_channel;                                                // cmd_mux:src_channel -> i2c_0_csr_agent:cp_channel
	wire          cmd_mux_src_startofpacket;                                          // cmd_mux:src_startofpacket -> i2c_0_csr_agent:cp_startofpacket
	wire          cmd_mux_src_endofpacket;                                            // cmd_mux:src_endofpacket -> i2c_0_csr_agent:cp_endofpacket
	...
	wire  [101:0] cmd_mux_001_src_data;                                               // cmd_mux_001:src_data -> pio_0_s1_agent:cp_data
	...
	wire          i2c_0_csr_agent_rp_valid;                                           // i2c_0_csr_agent:rp_valid -> router_001:sink_valid
	wire  [101:0] i2c_0_csr_agent_rp_data;                                            // i2c_0_csr_agent:rp_data -> router_001:sink_data
	wire          i2c_0_csr_agent_rp_ready;                                           // router_001:sink_ready -> i2c_0_csr_agent:rp_ready
	wire          i2c_0_csr_agent_rp_startofpacket;                                   // i2c_0_csr_agent:rp_startofpacket -> router_001:sink_startofpacket
	wire          i2c_0_csr_agent_rp_endofpacket;                                     // i2c_0_csr_agent:rp_endofpacket -> router_001:sink_endofpacket
	...
	wire          i2c_0_csr_agent_rdata_fifo_src_valid;                               // i2c_0_csr_agent:rdata_fifo_src_valid -> avalon_st_adapter:in_0_valid
	wire   [33:0] i2c_0_csr_agent_rdata_fifo_src_data;                                // i2c_0_csr_agent:rdata_fifo_src_data -> avalon_st_adapter:in_0_data
	wire          i2c_0_csr_agent_rdata_fifo_src_ready;                               // avalon_st_adapter:in_0_ready -> i2c_0_csr_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_out_0_valid;                                      // avalon_st_adapter:out_0_valid -> i2c_0_csr_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_out_0_data;                                       // avalon_st_adapter:out_0_data -> i2c_0_csr_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_out_0_ready;                                      // i2c_0_csr_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire    [0:0] avalon_st_adapter_out_0_error;                                      // avalon_st_adapter:out_0_error -> i2c_0_csr_agent:rdata_fifo_sink_error
	...
	qsys1_mm_interconnect_0_router_001 router_002 (
	...
	qsys1_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                                //       clk.clk
		.reset               (i2c_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	qsys1_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                //       clk.clk
		.reset              (i2c_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
